...
md`<div style="color: grey; font: 13px/25.5px var(--sans-serif); text-transform: uppercase;"><h1 style="display: none;">Beeswarm</h1><a href="https://d3js.org/">D3</a> › <a href="/@d3/gallery">Gallery</a></div>
...
md`The [dodge transform](/plot/transforms/dodge) is natively available in the [Observable Plot](/plot/) API, allowing you to create a similar chart with a few lines of code:`
)}

function _5(Plot,cars){return(
Plot.plot({
  height: 165,
  x: {line: true},
  marks: [
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("chart")).define("chart", ["d3","cars","dodge"], _chart);
  main.variable(observer("dodge")).define("dodge", _dodge);
  main.variable(observer()).define(["md"], _4);
  main.variable(observer()).define(["Plot","cars"], _5);
  return main;
}
